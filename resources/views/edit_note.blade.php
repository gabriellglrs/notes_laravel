    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col">
                ...
                <!-- form -->
                <form action="{{ route('editNoteSubmit', $note->uuid) }}" class="p-4" method="post">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control bg-primary text-white" name="text_text" rows="5">{{ old('text_text', $note->text) }}</textarea>
                            </div>
                            @error('text_text')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
